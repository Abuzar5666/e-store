    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                <h1>Find Best Product Here</h1>
                <p>Thounsands of products available.</p>
                <div class="banner-btn mt-5"><a href="#" c  lass="btn btn-primary mb-4 mb-sm-0">Explore Now</a></div>
            </div>
        </div>
    </div>
</section>
